...
export class Painter {
    ...
    render(style: Style, transform: IReadonlyTransform, options: PainterOptions): void {
        ...
        const renderContext = this.renderContext = new RenderContext(transform, style.projection, style.map.terrain ?? null, this.context, this.programs, options.showOverdrawInspector);
