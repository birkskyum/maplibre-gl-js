...
describe('drawSymbol', () => {
    test('should not do anything', () => {
        ...
        const renderContext = new RenderContext(null, undefined, null, null, {}, false);
    ...
    test('should call program.draw', () => {
        ...
        painterMock.renderContext = new RenderContext(createMockTransform(), undefined, null, painterMock.context, {}, false);
